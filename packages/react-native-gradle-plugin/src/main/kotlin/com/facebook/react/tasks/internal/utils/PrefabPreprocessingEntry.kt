 ...
 * @param pathToPrefixCouples A list of pairs Path to Header prefix. You can use this list
 * to supply a list of paths that you want to be considered for prefab. Each path can specify
 * an header prefix that will be used by prefab to re-created the header layout.
 */
